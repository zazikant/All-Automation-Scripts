1. last_processed_uid is not required , gemini agent automatically creates that . you just need to note the number and let gemini continue from their if its a active session
